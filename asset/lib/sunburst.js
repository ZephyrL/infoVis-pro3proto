...
!function(t, n) {
    ...
    function o(t) {
        var n = t += ""
          , e = n.indexOf(":");
        return 0 <= e && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)),
        i.hasOwnProperty(n) ? {
            space: i[n],
            local: t
        } : t
    ...
    function b(t, n, e, r, i, o, u) {
        var a, s, c, l = {}, f = n.length, h = o.length, p = new Array(f);
        for (a = 0; a < f; ++a)
            (s = n[a]) && (p[a] = c = g + u.call(s, s.__data__, a, n),
            c in l ? i[a] = s : l[c] = s);
        for (a = 0; a < h; ++a)
            (s = l[c = g + u.call(t, o[a], a, o)]) ? ((r[a] = s).__data__ = o[a],
            l[c] = null) : e[a] = new d(t,o[a]);
        for (a = 0; a < f; ++a)
            (s = n[a]) && l[p[a]] === s && (i[a] = s)
    }
    function f(t, n) {
        ...
        return function() {
            ...
            if (t) {
                for (var n, e = 0, r = -1, i = t.length; e < i; ++e)
                    n = t[e],
                    o.type && n.type !== o.type || n.name !== o.name ? t[++r] = n : this.removeEventListener(n.type, n.listener, n.capture);
    ...
    function L(s, c, l) {
        ...
        return function(t, n, e) {
            var r, i = this.__on, o = f(c, n, e);
            if (i)
                for (var u = 0, a = i.length; u < a; ++u)
                    if ((r = i[u]).type === s.type && r.name === s.name)
                        return this.removeEventListener(r.type, r.listener, r.capture),
                        this.addEventListener(r.type, r.listener = o, r.capture = l),
                        void (r.value = c);
            this.addEventListener(s.type, o, l),
            r = {
                type: s.type,
                name: s.name,
                value: c,
    ...
    function q() {
        return new I([[document.documentElement]],H)
    }
    function X(t) {
        return "string" == typeof t ? new I([[document.querySelector(t)]],[document.documentElement]) : new I([[t]],H)
    }
    function R(t, n) {
        return t < n ? -1 : n < t ? 1 : n <= t ? 0 : NaN
    }
    I.prototype = q.prototype = {
        ...
        data: function(t, n) {
            if (!t)
                ...
                d;
            var e, r = n ? b : M, i = this._parents, o = this._groups;
        ...
        merge: function(t) {
            for (var n = this._groups, e = t._groups, r = n.length, i = e.length, o = Math.min(r, i), u = new Array(r), a = 0; a < o; ++a)
                for (var s, c = n[a], l = e[a], f = c.length, h = u[a] = new Array(f), p = 0; p < f; ++p)
                    (s = c[p] || l[p]) && (h[p] = s);
            for (; a < r; ++a)
                u[a] = n[a];
        ...
        sort: function(e) {
            ...
            for (var n = this._groups, r = n.length, i = new Array(r), o = 0; o < r; ++o) {
                for (var u, a = n[o], s = a.length, c = i[o] = new Array(s), l = 0; l < s; ++l)
                    (u = a[l]) && (c[l] = u);
                c.sort(t)
            }
    ...
    }).right, Z = Math.sqrt(50), W = Math.sqrt(10), Q = Math.sqrt(2);
    function J(t, n, e) {
    ...
    function Ct(t) {
        return t instanceof st || (t = Mt(t)),
        t ? new Nt((t = t.rgb()).r,t.g,t.b,t.opacity) : new Nt
    }
    function At(t, n, e, r) {
    ...
    function kt(t, n, e, r) {
        return r <= 0 ? t = n = e = NaN : e <= 0 || 1 <= e ? t = n = NaN : n <= 0 && (t = NaN),
        new Dt(t,n,e,r)
    }
    function Dt(t, n, e, r) {
        this.h = +t,
    ...
    function It(t) {
        if (t instanceof qt)
            return new qt(t.l,t.a,t.b,t.opacity);
        if (t instanceof $t) {
            if (isNaN(t.h))
                return new qt(t.l,0,0,t.opacity);
            var n = t.h * Et;
            return new qt(t.l,Math.cos(n) * t.c,Math.sin(n) * t.c,t.opacity)
        }
        t instanceof Nt || (t = Ct(t));
        var e, r, i = Vt(t.r), o = Vt(t.g), u = Vt(t.b), a = Xt((.2225045 * i + .7168786 * o + .0606169 * u) / Ot);
        return i === o && o === u ? e = r = a : (e = Xt((.4360747 * i + .3850649 * o + .1430804 * u) / Ft),
        r = Xt((.0139322 * i + .0971045 * o + .7141733 * u) / Yt)),
        new qt(116 * a - 16,500 * (e - a),200 * (a - r),t.opacity)
    }
    function qt(t, n, e, r) {
        this.l = +t,
        this.a = +n,
    ...
    ut($t, function(t, n, e, r) {
        return 1 === arguments.length ? function(t) {
            ...
            if (t instanceof qt || (t = It(t)),
            0 === t.a && 0 === t.b)
                return new $t(NaN,0,t.l,t.opacity);
    ...
    function ln(t, r) {
        var n, e, i, o, u, a = sn.lastIndex = cn.lastIndex = 0, s = -1, c = [], l = [];
        for (t += "",
        r += ""; (n = sn.exec(t)) && (e = cn.exec(r)); )
            (i = e.index) > a && (i = r.slice(a, i),
            c[s] ? c[s] += i : c[++s] = i),
            (n = n[0]) === (e = e[0]) ? c[s] ? c[s] += e : c[++s] = e : (c[++s] = null,
            l.push({
                i: s,
                x: an(n, e)
            })),
            a = cn.lastIndex;
        return a < r.length && (i = r.slice(a),
        c[s] ? c[s] += i : c[++s] = i),
        c.length < 2 ? l[0] ? (u = l[0].x,
        function(t) {
            return u(t) + ""
        }
        ) : (o = r,
    ...
    function fn(t, n) {
        var e, r = typeof n;
        return null == n || "boolean" === r ? en(n) : ("number" === r ? an : "string" === r ? (e = Mt(n)) ? (n = e,
        un) : ln : n instanceof Mt ? un : n instanceof Date ? function(n, e) {
            var r = new Date;
            return e -= n = +n,
            function(t) {
                return r.setTime(n + e * t),
                r
            }
        }
    ...
    var pn, dn, gn, yn, vn = 180 / Math.PI, mn = {
        translateX: 0,
        translateY: 0,
        rotate: 0,
        skewX: 0,
        ...
        return function(t, n) {
            ...
            function(t, n, e, r, i, o) {
                if (t !== e || n !== r) {
                    ...
                    (e || r) && i.push("translate(" + e + p + r + d)
            }(t.translateX, t.translateY, n.translateX, n.translateY, l, f),
            e = t.rotate,
            r = n.rotate,
            i = l,
            o = f,
            e !== r ? (180 < e - r ? r += 360 : 180 < r - e && (e += 360),
            o.push({
                i: i.push(y(i) + "rotate(", null, g) - 2,
                x: an(e, r)
            })) : r && i.push(y(i) + "rotate(" + r + g),
            u = t.skewX,
            a = n.skewX,
            s = l,
            c = f,
            ...
            function(t, n, e, r, i, o) {
                if (t !== e || n !== r) {
                    ...
                    1 === e && 1 === r || i.push(y(i) + "scale(" + e + "," + r + ")")
            }(t.scaleX, t.scaleY, n.scaleX, n.scaleY, l, f),
            t = n = null,
            function(t) {
    ...
    var xn = wn(function(t) {
        return "none" === t ? mn : (pn || (pn = document.createElement("DIV"),
        dn = document.documentElement,
        gn = document.defaultView),
        pn.style.transform = t,
        t = gn.getComputedStyle(dn.appendChild(pn), null).getPropertyValue("transform"),
        dn.removeChild(pn),
        _n(+(t = t.slice(7, -1).split(","))[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
    }, "px, ", "px)", "deg)")
      , Mn = wn(function(t) {
        return null == t ? mn : (yn || (yn = document.createElementNS("http://www.w3.org/2000/svg", "g")),
        yn.setAttribute("transform", t),
        (t = yn.transform.baseVal.consolidate()) ? _n((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : mn)
    }, ", ", ")", ")");
    Math.SQRT2;
    function bn(t) {
        return function() {
    ...
    function Dn(n, e) {
        var r, o, u, a = Cn, s = Cn, c = fn, l = !1;
        function i() {
            return r = 2 < Math.min(a.length, s.length) ? Sn : Nn,
            o = u = null,
            t
        }
        function t(t) {
            return (o || (o = r(a, s, l ? (i = n,
            function(n, e) {
                var r = i(n = +n, e = +e);
                return function(t) {
        ...
        ,
        t.domain = function(t) {
            return arguments.length ? (a = it.call(t, Tn),
            i()) : a.slice()
        }
        ,
        t.range = function(t) {
            return arguments.length ? (s = ot.call(t),
            i()) : s.slice()
        }
        ,
    ...
    function Rn(t) {
        var n, a, s, M = t.grouping && t.thousands ? (a = t.grouping,
        s = t.thousands,
        function(t, n) {
            for (var e = t.length, r = [], i = 0, o = a[0], u = 0; 0 < e && 0 < o && (n < u + o + 1 && (o = Math.max(1, n - u)),
            r.push(t.substring(e -= o, e + o)),
            !((u += o + 1) > n)); )
                o = a[i = (i + 1) % a.length];
            return r.reverse().join(s)
        }
        ) : zn, r = t.currency, b = t.decimal, T = t.numerals ? (n = t.numerals,
        function(t) {
        ...
        function u(t) {
            ...
            function e(t) {
                ...
                if ("c" === v)
                    ...
                    u && 0 == +t && (u = !1),
                    i = (u ? "(" === f ? f : "-" : "-" === f || "(" === f ? "" : f) + i,
                    o = ("s" === v ? Xn[8 + Pn / 3] : "") + o + (u && "(" === f ? ")" : ""),
                    x)
                        for (n = -1,
                        e = t.length; ++n < e; )
                            if ((r = t.charCodeAt(n)) < 48 || 57 < r) {
                                o = (46 === r ? b + t.slice(n + 1) : t.slice(n)) + o,
                                t = t.slice(0, n);
                                break
                            }
                }
                ...
                switch (d && h && (t = M(s + t, s.length ? p - o.length : 1 / 0),
                s = ""),
                l) {
                case "<":
                    t = i + t + o + s;
            ...
            return g = null == g ? 6 : /[gprs]/.test(v) ? Math.max(1, Math.min(21, g)) : Math.max(0, Math.min(20, g)),
            e.toString = function() {
                return t + ""
            }
            ,
    ...
    function Bn(t, n, e) {
        var r, i, o, u, a, s, c, l, f, h, p, d, g = t[0], y = t[t.length - 1], v = (i = g,
        o = y,
        u = null == n ? 10 : n,
        a = Math.abs(o - i) / Math.max(0, u),
        s = Math.pow(10, Math.floor(Math.log(a) / Math.LN10)),
        Z <= (c = a / s) ? s *= 10 : W <= c ? s *= 5 : Q <= c && (s *= 2),
        o < i ? -s : s);
        switch ((e = On(null == e ? ",f" : e)).type) {
        case "s":
            var m = Math.max(Math.abs(g), Math.abs(y));
            return null != e.precision || isNaN((p = v,
            d = m,
            r = Math.max(0, 3 * Math.max(-8, Math.min(8, Math.floor(En(d) / 3))) - En(Math.abs(p))))) || (e.precision = r),
            qn(e, m);
        case "":
        case "e":
        case "g":
        case "p":
        case "r":
            null != e.precision || isNaN((f = v,
            h = Math.max(Math.abs(g), Math.abs(y)),
            f = Math.abs(f),
            h = Math.abs(h) - f,
            r = Math.max(0, En(h) - En(f)) + 1)) || (e.precision = r - ("e" === e.type));
            break;
        case "f":
        case "%":
            null != e.precision || isNaN((l = v,
            r = Math.max(0, -En(Math.abs(l))))) || (e.precision = r - 2 * ("%" === e.type))
        }
        return In(e)
    }
    function Vn(a) {
        ...
        a.nice = function(t) {
            null == t && (t = 10);
            var n, e = s(), r = 0, i = e.length - 1, o = e[r], u = e[i];
            return u < o && (n = o,
            o = u,
            u = n,
            n = r,
            r = i,
            i = n),
            0 < (n = J(o, u, t)) ? n = J(o = Math.floor(o / n) * n, u = Math.ceil(u / n) * n, t) : n < 0 && (n = J(o = Math.ceil(o * n) / n, u = Math.floor(u * n) / n, t)),
            0 < n ? (e[r] = Math.floor(o / n) * n,
            e[i] = Math.ceil(u / n) * n,
            s(e)) : n < 0 && (e[r] = Math.ceil(o * n) / n,
            e[i] = Math.floor(u * n) / n,
            s(e)),
            a
        }
        ,
    ...
    function Jn(o, u, e, r) {
        function a(t) {
            return o(t = new Date(+t)),
            t
        }
        return (a.floor = a).ceil = function(t) {
            return o(t = new Date(t - 1)),
            u(t, 1),
            o(t),
            t
        }
        ...
        a.offset = function(t, n) {
            return u(t = new Date(+t), null == n ? 1 : Math.floor(n)),
            t
        }
        ,
        ...
        a.every = function(n) {
            ...
            isFinite(n) && 0 < n ? 1 < n ? a.filter(r ? function(t) {
                return r(t) % n == 0
            }
            : function(t) {
    ...
    Gn.every = function(e) {
        ...
        isFinite(e) && 0 < e ? 1 < e ? Jn(function(t) {
    ...
    Jn(function(t) {
        ...
        n < 0 && (n += te),
        t.setTime(Math.floor((+t - n) / te) * te + n)
    }, function(t, n) {
        t.setTime(+t + n * te)
    }, function(t, n) {
        return (n - t) / te
    ...
    function Pe(t, n, e) {
        var r = we.exec(n.slice(e, e + 2));
        return r ? (t.y = +r[0] + (68 < +r[0] ? 1900 : 2e3),
        e + r[0].length) : -1
    }
    function Fe(t, n, e) {
    ...
    function rr(t, n) {
        var e = t.getDay();
        return t = 4 <= e || 0 === e ? oe(t) : oe.ceil(t),
        be(oe.count(ue(t), t) + (4 === ue(t).getDay()), n, 2)
    }
    function ir(t) {
        return t.getDay()
    }
    ...
    function wr(t, n) {
        var e = t.getUTCDay();
        return t = 4 <= e || 0 === e ? fe(t) : fe.ceil(t),
        be(fe.count(he(t), t) + (4 === he(t).getUTCDay()), n, 2)
    }
    function xr(t) {
        return t.getUTCDay()
    }
    ...
    ye = function(t) {
        ...
        function M(s, c) {
            return function(t) {
                var n, e, r, i = [], o = -1, u = 0, a = s.length;
                for (t instanceof Date || (t = new Date(+t)); ++o < a; )
                    37 === s.charCodeAt(o) && (i.push(s.slice(u, o)),
                    null != (e = _e[n = s.charAt(++o)]) ? n = s.charAt(++o) : e = "e" === n ? " " : "0",
                    (r = c[n]) && (n = r(t, e)),
                    i.push(n),
                    u = o + 1);
                return i.push(s.slice(u, o)),
                i.join("")
            }
        }
        function b(i, o) {
            return function(t) {
                ...
                "V"in r) {
                    if (r.V < 1 || 53 < r.V)
                        return null;
                    "w"in r || (r.w = 1),
                    "Z"in r ? (n = 4 < (e = (n = de(ge(r.y))).getUTCDay()) || 0 === e ? le.ceil(n) : le(n),
                    n = ae.offset(n, 7 * (r.V - 1)),
                    r.y = n.getUTCFullYear(),
                    r.m = n.getUTCMonth(),
                    r.d = n.getUTCDate() + (r.w + 6) % 7) : (n = 4 < (e = (n = o(ge(r.y))).getDay()) || 0 === e ? ie.ceil(n) : ie(n),
                    n = ne.offset(n, 7 * (r.V - 1)),
                    r.y = n.getFullYear(),
                    r.m = n.getMonth(),
                    r.d = n.getDate() + (r.w + 6) % 7)
                } else
                    ("W"in r || "U"in r) && ("w"in r || (r.w = "u"in r ? r.u % 7 : "W"in r ? 1 : 0),
                    e = "Z"in r ? de(ge(r.y)).getUTCDay() : o(ge(r.y)).getDay(),
                    r.m = 0,
                    r.d = "W"in r ? (r.w + 6) % 7 + 7 * r.W - (e + 5) % 7 : r.w + 7 * r.U - (e + 6) % 7);
        ...
        function T(t, n, e, r) {
            for (var i, o, u = 0, a = n.length, s = e.length; u < a; ) {
                ...
                if (37 === (i = n.charCodeAt(u++))) {
                    if (i = n.charAt(u++),
                    !(o = x[i in _e ? n.charAt(u++) : i]) || (r = o(t, e, r)) < 0)
                        return -1
    ...
    Date.prototype.toISOString || ve(kr);
    +new Date("2000-01-01T00:00:00.000Z") || me(kr);
    function Dr(t) {
        var n = 0
          , e = t.children
          , r = e && e.length;
    ...
    function Fr(t) {
        for (var n = 0; t.height = n,
        (t = t.parent) && t.height < ++n; )
            ;
    }
    function Or(t) {
        this.data = t,
        ...
        function n(t) {
            ...
            function(t) {
                t.children && function(t, n, e, r, i) {
                    for (var o, u = t.children, a = -1, s = u.length, c = t.value && (r - n) / t.value; ++a < s; )
                        (o = u[a]).y0 = e,
                        o.y1 = i,
                        o.x0 = n,
                        o.x1 = n += o.value * c
    ...
    Or.prototype = Ur.prototype = {
        ...
        sum: function(i) {
            return this.eachAfter(function(t) {
                for (var n = +i(t.data) || 0, e = t.children, r = e && e.length; 0 <= --r; )
                    n += e[r].value;
                t.value = n
            })
        },
    ...
    qr.prototype = Xr.prototype = {
            ...
            if (null === this._x1)
                ...
                if (Math.abs(l * a - s * c) > Hr && i) {
                    var h = e - o
                      ...
                      , _ = m / v
                      , w = m / y;
                    Math.abs(_ - 1) > Hr && (this._ += "L" + (t + _ * c) + "," + (n + _ * l)),
                    this._ += "A" + i + "," + i + ",0,0," + +(c * p < l * h) + "," + (this._x1 = t + w * a) + "," + (this._y1 = n + w * s)
                } else
                    this._ += "L" + (this._x1 = t) + "," + (this._y1 = n);
            else
                ;
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            null === this._x1 ? this._ += "M" + s + "," + c : (Math.abs(this._x1 - s) > Hr || Math.abs(this._y1 - c) > Hr) && (this._ += "L" + s + "," + c),
            e && (f < 0 && (f = f % zr + zr),
            Ir < f ? this._ += "A" + e + "," + e + ",0,1," + l + "," + (t - u) + "," + (n - a) + "A" + e + "," + e + ",0,1," + l + "," + (this._x1 = s) + "," + (this._y1 = c) : Hr < f && (this._ += "A" + e + "," + e + ",0," + +(Lr <= f) + "," + l + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
        },
    ...
    function ci() {
        var Z = ri
          ...
          , nt = null;
        function n() {
            var t, n, e, r, i, o, u, a, s, c, l, f, h = +Z.apply(this, arguments), p = +W.apply(this, arguments), d = G.apply(this, arguments) - ti, g = K.apply(this, arguments) - ti, y = Br(g - d), v = d < g;
            if (nt || (nt = t = Xr()),
            p < h && (n = p,
            p = h,
            h = n),
            Gr < p)
                if (ni - Gr < y)
                    nt.moveTo(p * $r(d), p * Qr(d)),
                    nt.arc(0, 0, p, d, g, !v),
                    Gr < h && (nt.moveTo(h * $r(g), h * Qr(g)),
                    nt.arc(0, 0, h, g, d, v));
                else {
                    var m, _, w = d, x = g, M = d, b = g, T = y, C = y, A = tt.apply(this, arguments) / 2, N = Gr < A && (J ? +J.apply(this, arguments) : Jr(h * h + p * p)), S = Wr(Br(p - h) / 2, +Q.apply(this, arguments)), k = S, D = S;
                    if (Gr < N) {
                        var U = ei(N / h * Qr(A))
                          , E = ei(N / p * Qr(A));
                        (T -= 2 * U) > Gr ? (M += U *= v ? 1 : -1,
                    ...
                    Gr < C ? Gr < D ? (m = si(z, H, P, F, p, D, v),
                    _ = si(j, L, O, Y, p, D, v),
                    nt.moveTo(m.cx + m.x01, m.cy + m.y01),
                    D < S ? nt.arc(m.cx, m.cy, D, Vr(m.y01, m.x01), Vr(_.y01, _.x01), !v) : (nt.arc(m.cx, m.cy, D, Vr(m.y01, m.x01), Vr(m.y11, m.x11), !v),
                    nt.arc(0, 0, p, Vr(m.cy + m.y11, m.cx + m.x11), Vr(_.cy + _.y11, _.cx + _.x11), !v),
                    nt.arc(_.cx, _.cy, D, Vr(_.y11, _.x11), Vr(_.y01, _.x01), !v))) : (nt.moveTo(P, F),
                    nt.arc(0, 0, p, w, x, !v)) : nt.moveTo(P, F),
                    Gr < h && Gr < T ? Gr < k ? (m = si(O, Y, j, L, h, -k, v),
                    _ = si(P, F, z, H, h, -k, v),
                    nt.lineTo(m.cx + m.x01, m.cy + m.y01),
                    k < S ? nt.arc(m.cx, m.cy, k, Vr(m.y01, m.x01), Vr(_.y01, _.x01), !v) : (nt.arc(m.cx, m.cy, k, Vr(m.y01, m.x01), Vr(m.y11, m.x11), !v),
                    nt.arc(0, 0, h, Vr(m.cy + m.y11, m.cx + m.x11), Vr(_.cy + _.y11, _.cx + _.x11), v),
                    nt.arc(_.cx, _.cy, k, Vr(_.y11, _.x11), Vr(_.y01, _.x01), !v))) : nt.arc(0, 0, h, b, M, v) : nt.lineTo(O, Y)
                }
            else
                nt.moveTo(0, 0);
            if (nt.closePath(),
        ...
        n.innerRadius = function(t) {
            return arguments.length ? (Z = "function" == typeof t ? t : Rr(+t),
            n) : Z
        }
        ,
        n.outerRadius = function(t) {
            return arguments.length ? (W = "function" == typeof t ? t : Rr(+t),
            n) : W
        }
        ,
        n.cornerRadius = function(t) {
            return arguments.length ? (Q = "function" == typeof t ? t : Rr(+t),
            n) : Q
        }
        ,
        n.padRadius = function(t) {
            return arguments.length ? (J = null == t ? null : "function" == typeof t ? t : Rr(+t),
            n) : J
        }
        ,
        n.startAngle = function(t) {
            return arguments.length ? (G = "function" == typeof t ? t : Rr(+t),
            n) : G
        }
        ,
        n.endAngle = function(t) {
            return arguments.length ? (K = "function" == typeof t ? t : Rr(+t),
            n) : K
        }
        ,
        n.padAngle = function(t) {
            return arguments.length ? (tt = "function" == typeof t ? t : Rr(+t),
            n) : tt
        }
        ,
        n.context = function(t) {
            return arguments.length ? (nt = null == t ? null : t,
            n) : nt
        }
        ,
        n
    ...
    di.prototype = {
        ...
        point: function(t, n) {
            ...
            (t = +t) !== this._x1 || n !== this._y1) {
                ...
                case 2:
                    this._point = 3,
                    pi(this, hi(this, e = fi(this, t, n)), e);
                    break;
                default:
            ...
            if (!(arguments.length < 2)) {
                ...
                for (; ++u < a; )
                    if (e = (t = o[u]).type)
                        ...
                        for (e in i)
                            i[e] = wi(i[e], t.name, null);
                return this
            }
            for (; ++u < a; )
                if ((e = (t = o[u]).type) && (e = _i(i[e], t.name)))
                    return e
        },
        copy: function() {
            var t = {}
    ...
    var xi, Mi, bi = 0, Ti = 0, Ci = 0, Ai = 1e3, Ni = 0, Si = 0, ki = 0, Di = "object" == typeof performance && performance.now ? performance : Date, Ui = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
        setTimeout(t, 17)
    }
    ;
    function Ei() {
    ...
    function Yi() {
        ...
        try {
            !function() {
                ...
                ++bi;
                for (var t, n = xi; n; )
                    0 <= (t = Si - n._time) && n._call.call(null, t),
                    n = n._next;
                --bi
            }()
        } finally {
    ...
    function Li(t) {
        bi || (Ti && (Ti = clearTimeout(Ti)),
        24 < t - Si ? (t < 1 / 0 && (Ti = setTimeout(Yi, t - Di.now() - ki)),
        Ci && (Ci = clearInterval(Ci))) : (Ci || (Ni = Di.now(),
        Ci = setInterval(ji, Ai)),
        bi = 1,
        Ui(Yi)))
    }
    function zi(n, e, t) {
    ...
    Fi.prototype = Oi.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            e = (null == e ? Ei() : +e) + (null == n ? 0 : +n),
            this._next || Mi === this || (Mi ? Mi._next = this : xi = this,
            Mi = this),
            this._call = t,
            this._time = e,
            Li()
            ...
            function l(t) {
                ...
                for (n in c)
                    if ((i = c[n]).name === a.name) {
                        if (i.state === Bi)
                            return zi(l);
                        i.state === Vi ? (i.state = Zi,
                        i.timer.stop(),
                        i.on.call("interrupt", o, o.__data__, i.index, i.group),
                        delete c[n]) : +n < u && (i.state = Zi,
                        i.timer.stop(),
                        delete c[n])
                    }
                if (zi(function() {
                    a.state === Bi && (a.state = Vi,
                    a.timer.restart(f, a.delay, a.time),
                    f(t))
                }),
                a.state = Ri,
                a.on.call("start", o, o.__data__, a.index, a.group),
                a.state === Ri) {
                    for (a.state = Bi,
                    s = new Array(r = a.tween.length),
                    n = 0,
                    e = -1; n < r; ++n)
                        (i = a.tween[n].value.call(o, o.__data__, a.index, a.group)) && (s[++e] = i);
                    s.length = e + 1
                }
            }
            function f(t) {
                for (var n = t < a.duration ? a.ease.call(null, t / a.duration) : (a.timer.restart(h),
                a.state = $i,
                1), e = -1, r = s.length; ++e < r; )
                    s[e].call(null, n);
                a.state === $i && (a.on.call("end", o, o.__data__, a.index, a.group),
                h())
            }
            function h() {
                for (var t in a.state = Zi,
                a.timer.stop(),
                delete c[u],
                c)
                    return;
    ...
    function to(t, n) {
        var e;
        return ("number" == typeof n ? an : n instanceof Mt ? un : (e = Mt(n)) ? (n = e,
        un) : ln)(t, n)
    }
    ...
    ro.prototype = io.prototype = {
        ...
        select: function(t) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
                for (var a, s, c = r[u], l = c.length, f = o[u] = new Array(l), h = 0; h < l; ++h)
                    (a = c[h]) && (s = t.call(a, a.__data__, h, c)) && ("__data__"in a && (s.__data__ = a.__data__),
                    f[h] = s,
                    Wi(f[h], n, e, h, f, Gi(a, e)));
        ...
        selectAll: function(t) {
            ...
            for (var r = this._groups, i = r.length, o = [], u = [], a = 0; a < i; ++a)
                for (var s, c = r[a], l = c.length, f = 0; f < l; ++f)
                    if (s = c[f]) {
                        for (var h, p = t.call(s, s.__data__, f, c), d = Gi(s, e), g = 0, y = p.length; g < y; ++g)
                            (h = p[g]) && Wi(h, n, e, g, p, d);
                        o.push(p),
                        u.push(s)
                    }
        ...
        on: function(t, n) {
            ...
            return arguments.length < 2 ? Gi(this.node(), s).on.on(t) : this.each((e = s,
            i = n,
            a = ((r = t) + "").trim().split(/^|\s+/).every(function(t) {
                var n = t.indexOf(".");
                return 0 <= n && (t = t.slice(0, n)),
                !t || "start" === t
            }) ? Qi : Ji,
            function() {
                var t = a(this, e)
        ...
        attr: function(t, n) {
            ...
            return this.attrTween(t, "function" == typeof n ? (e.local ? function(e, r, i) {
                ...
                return function() {
                    var t, n = i(this);
                    if (null != n)
                        return (t = this.getAttributeNS(e.space, e.local)) === n ? null : t === o && n === u ? a : a = r(o = t, u = n);
            ...
            : function(e, r, i) {
                ...
                return function() {
                    var t, n = i(this);
                    if (null != n)
                        return (t = this.getAttribute(e)) === n ? null : t === o && n === u ? a : a = r(o = t, u = n);
        ...
        style: function(t, n, e) {
            ...
            return null == n ? this.styleTween(t, (g = t,
            y = w,
            function() {
                var t = x(this, g)
                  , n = (this.style.removeProperty(g),
                x(this, g));
            ...
            )) : this.styleTween(t, "function" == typeof n ? (c = w,
            l = Ki(this, "style." + (s = t), n),
            function() {
                var t = x(this, s)
                  , n = l(this);
                return null == n && (this.style.removeProperty(s),
                n = x(this, s)),
                t === n ? null : t === f && n === h ? p : p = c(f = t, h = n)
            }
            ) : (r = t,
            i = w,
            o = n + "",
        ...
        text: function(t) {
            return this.tween("text", "function" == typeof t ? (e = Ki(this, "text", t),
            function() {
                var t = e(this);
                this.textContent = null == t ? "" : t
            }
        ...
        return this.each(function() {
            !function(t, n) {
                ...
                if (o) {
                    ...
                    o)
                        (e = o[i]).name === n ? (r = e.state > Ri && e.state < $i,
                        e.state = Zi,
                        e.timer.stop(),
    ...
    q.prototype.transition = function(t) {
        var n, e;
        t instanceof ro ? (n = t._id,
        t = t._name) : (n = oo(),
        (e = ao).time = Ei(),
        t = null == t ? null : t + "");
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
            for (var u, a = r[o], s = a.length, c = 0; c < s; ++c)
                (u = a[c]) && Wi(u, t, n, c, a, e || so(u, n));
    ...
    var fo = lo(function(t, n) {
                ...
                n.default = function(t) {
                    ...
                    return function() {
                        ...
                        Object.keys(a).forEach(function(i) {
                            u[i] = function() {
                                for (var t, n = arguments.length, e = Array(n), r = 0; r < n; r++)
                                    e[r] = arguments[r];
        ...
        , function(t, n) {
            t.exports = function(n, e, r) {
                ...
                function c() {
                    var t = Date.now() - a;
                    t < e && 0 <= t ? i = setTimeout(c, e - t) : (i = null,
                    r || (s = n.apply(u, o),
                    u = o = null))
                }
                null == e && (e = 100);
    ...
    lo(function(t, n) {
        t.exports = function(e) {
            ...
            var r, i, o;
            i = [t, n],
            void 0 !== (o = "function" == typeof (r = function(t, n) {
                Object.defineProperty(n, "__esModule", {
                    value: !0
                }),
    ...
    return ho({
        ...
        init: function(t, n) {
            ...
            n.angleScale = function t() {
                ...
                ,
                Vn(n)
            }().domain([0, 10]).range([0, 2 * Math.PI]).clamp(!0),
            n.arc = ci().startAngle(function(t) {
            ...
            n.tooltip = X("body").append("div").attr("class", "sunburst-tooltip"),
        ...
        update: function(a) {
            ...
            if (a.radiusScale.range([.1 * t, t]),
            a.svg.style("width", a.width + "px").style("height", a.height + "px").attr("viewBox", -a.width / 2 + " " + -a.height / 2 + " " + a.width + " " + a.height),
            a.layoutData) {
                ...
                a.svg.transition(u).tween("scale", function() {
                    ...
                    return function(t) {
                        a.angleScale.domain(n(t)),
                        a.radiusScale.domain(e(t))
                    }
                });
                ...
                var c = e.enter().append("g").attr("class", "slice").style("opacity", 0).on("click", function(t) {
                    F.stopPropagation(),
                    (a.onNodeClick || n.focusOnNode)(t.data)
                }).on("mouseover", function(t) {
                    a.tooltip.style("display", "inline"),
                    a.tooltip.html('<div class="tooltip-title">' + function(t) {
                        var n = []
                          , e = t;
                        for (; e; )
                            n.unshift(e),
                ...
                var f = e.merge(c);
                f.style("opacity", 1),
                f.select("path.main-arc").transition(u).attrTween("d", function(t) {
                    return function() {
                        return a.arc(t)
                    }
                ...
                f.select(".path-label").transition(u).styleTween("display", function(r) {
                    return function() {
                        return a.showLabels && (t = r,
                        n = a.angleScale(t.x1) - a.angleScale(t.x0),
                        e = Math.max(0, (a.radiusScale(t.y0) + a.radiusScale(t.y1)) / 2) * n,
                        6 * i(t.data).toString().length < e) ? null : "none";
                        var t, n, e
                    }
                }),
                f.selectAll("text.path-label").select("textPath.text-contour"),
                f.selectAll("text.path-label").select("textPath.text-stroke"),
                f.selectAll("text.path-label").selectAll("textPath").text(function(t) {
                    return i(t.data)
                })
            }
            function h(t) {
